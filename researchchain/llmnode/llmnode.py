...
if __name__ == "__main__":    
    ...
    graph_builder.add_node("translater1", LLMNode(llm_name=llm_name, setting=translater1_setting))
    graph_builder.add_node("translater2", LLMNode(llm_name=llm_name, setting=translater2_setting))
    graph_builder.add_node("translater3", LLMNode(llm_name=llm_name, setting=translater3_setting))
