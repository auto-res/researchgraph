import os
from researchgraph.graphs.ai_integrator.ai_integrator_v3.add_paper_subgraph.main import AddPaperSubgraph
...
def test_add_paper_subgraph():
    ...
    assert add_paper_subgraph(state = add_paper_subgraph_input_data, )
