import os
from researchgraph.graphs.ai_integrator.ai_integrator_v3.base_paper_subgraph.main import BasePaperSubgraph
...
def test_base_paper_subgraph():
    ...
    assert base_paper_subgraph(state = base_paper_subgraph_input_data, )
