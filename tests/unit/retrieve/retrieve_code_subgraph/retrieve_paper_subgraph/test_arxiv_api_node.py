...
@patch("airas.retrieve_paper_subgraph.nodes.arxiv_api_node.requests.get")
@patch("airas.retrieve_paper_subgraph.nodes.arxiv_api_node.feedparser.parse")
...
@patch(
    "airas.retrieve_paper_subgraph.nodes.arxiv_api_node.requests.get",
    side_effect=Exception("API error"),
)
@patch(
    "airas.retrieve_paper_subgraph.nodes.arxiv_api_node.feedparser.parse",
