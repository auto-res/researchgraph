...
import requests
from airas.research_preparation_subgraph.nodes.fork_repository import fork_repository


# Normal case test: returns True when status_code is 202
@patch("airas.research_preparation_subgraph.nodes.fork_repository.requests.post")
...
@patch(
    "airas.research_preparation_subgraph.nodes.fork_repository.requests.post",
