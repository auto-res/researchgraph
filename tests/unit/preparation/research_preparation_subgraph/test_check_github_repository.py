...
@patch("airas.research_preparation_subgraph.nodes.check_github_repository.requests.get")
...
@patch(
    "airas.research_preparation_subgraph.nodes.check_github_repository.requests.get",
