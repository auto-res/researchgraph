...
@patch("airas.research_preparation_subgraph.nodes.check_branch_existence.requests.get")
...
@patch(
    "airas.research_preparation_subgraph.nodes.check_branch_existence.requests.get",
