...
@patch(
    "airas.retrieve_paper_subgraph.nodes.generate_queries_node.openai_client",
    return_value='{"generated_query_1": "q1", "generated_query_2": "q2", "generated_query_3": "q3", "generated_query_4": "q4", "generated_query_5": "q5"}',
)
