...
import requests
from airas.research_preparation_subgraph.nodes.create_branch import create_branch


# Normal case test: returns True when status_code is 201
@patch("airas.research_preparation_subgraph.nodes.create_branch.requests.post")
...
@patch(
    "airas.research_preparation_subgraph.nodes.create_branch.requests.post",
