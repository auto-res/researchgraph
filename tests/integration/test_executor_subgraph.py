...
@patch(
    "airas.executor_subgraph.nodes.generate_code_with_devin.generate_code_with_devin",
    return_value=("mock_session", "https://devin.ai/mock"),
)
@patch(
    "airas.executor_subgraph.nodes.execute_github_actions_workflow.execute_github_actions_workflow",
    return_value=123456,
)
@patch(
    "airas.executor_subgraph.nodes.retrieve_github_actions_artifacts.retrieve_github_actions_artifacts",
    return_value=("Mock output", "Mock error"),
)
@patch("airas.executor_subgraph.nodes.llm_decide.llm_decide", return_value=False)
@patch(
    "airas.executor_subgraph.nodes.fix_code_with_devin.fix_code_with_devin",
    return_value=0,
)
@patch(
    "airas.executor_subgraph.nodes.check_devin_completion.check_devin_completion",
    return_value=True,
)
