...
import json
from airas.latex_subgraph.latex_subgraph import LatexSubgraph
...
@patch(
    "airas.latex_subgraph.nodes.compile_to_pdf.LatexNode.execute",
    return_value="Generated LaTeX text",
)
@patch(
    "airas.latex_subgraph.nodes.convert_to_latex.openai_client",
