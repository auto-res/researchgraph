...
class LLMTrainNode:
    def __init__(
        self, model_name, dataset_name, model_save_path, input_variable, output_variable
    ):
...
if __name__ == "__main__":
    ...
    input_variable = ""
    output_variable = "method_1_model_save_path"

    graph_builder = StateGraph(State)
    graph_builder.add_node(
        "llmtrainer",
        LLMTrainNode(
            model_name, dataset_name, model_save_path, input_variable, output_variable
        ),
    )
    ...
    memory = {"method_1_model_save_path": ""}
